...
plot(0.5, 0.5, type = 'n', axes = FALSE, xlim = c(0, 1), ylim = c(0, 1),
    xlab = '', ylab = '')
text(0.2, 0.6, "Default value for op$mai and op$mar", adj = 0)
text(0.2, 0.5, paste0("op$mar = c(", paste(op$mar - 0.1, collapse = ", "), ") + 0.1"), adj = 0)
text(0.2, 0.4, paste0("op$mai = c(", paste(op$mai, collapse = ", "), ")"), adj = 0)
